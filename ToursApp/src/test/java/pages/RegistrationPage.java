...
WebDriver driver;
	...
	@FindBy(xpath = "//b[contains(text(),'Note: Your user name is 10prasanth@gmail.com.')]") WebElement registeredUsername;
	...
	public Object registration(String firstName,String lastName,String phone,String userName,String address1,String address2,String city,
			String state,String country,String email,String password,String confirmPassword) {
